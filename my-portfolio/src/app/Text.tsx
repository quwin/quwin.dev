...
export default function Text({ label }: TextProps) {
    if (label === "about") {
        ...
        return <div className="font-lato text-xl my-8">
            ...
            <TypeAnimation sequence={[" a software developer 💻!", 2000, "a boba lover 🧋!", 2000, "a gym go-er 🏋️!", 2000, "a basketball enjoyer 🏀!", 2000, "a poker player ♠️!", 2000]} speed={50} deletionSpeed={75} repeat={Infinity} className="ml-1"></TypeAnimation>
            </div>
