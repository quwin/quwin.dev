...
export default function Projects() {
    ...
    const apiArray = ["Go", "Nginx", "Redis", "Docker", "AWS"];
    ...
    const infiniportalArray = ["Python", "Javascript", "Postgres", "SQL", "Quart", "Docker", "Google Cloud"]
    ...
    return (
        <div>
            ...
            <Project name="infiniportal" link="https://github.com/quwin/infiniportal" description="A full-stack web platform with Discord-verified chatbot for community engagement + utilities" stack={infiniportalArray} startMonth="May" startYear="2024" endMonth="August" endYear="2024"></Project>
            <Project name="API Gateway + Rate limiter" link="https://github.com/quwin/API-Gateway" description="A configurable production API gateway enforcing per-plan rate limits balanced across multiple instances" stack={apiArray} startMonth="June" startYear="2026" endMonth="July" endYear="2026"></Project>
            <Project name="Portfolio Website" link="https://github.com/quwin/quwin.dev" description="This portfolio website!" stack={portfolioArray} startMonth="June" startYear="2026" endMonth="June" endYear="2026"></Project>
            <Project name="Belevator" link="https://github.com/quwin/Belevator-Tactics" description="A cross-platform deterministic physics-based mobile game, available on iOS and Android" stack={belevatorArray} startMonth="June" startYear="2025" endMonth="April" endYear="2026"></Project>
